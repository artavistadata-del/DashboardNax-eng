...
const SLIDES = [
  {
    headline: 'Kendalikan\nPengiriman Global.',
    sub: 'Pantau status angkutan udara & laut, kelola dokumen, dan koordinasikan klien — semua dalam satu platform.',
  },
  {
    headline: 'Penyimpanan Dingin\nReal-Time.',
    sub: 'Pantau suhu kontainer berpendingin dari mana saja. Peringatan otomatis saat terjadi anomali.',
  },
  {
    headline: 'Data Aman,\nOperasi Lancar.',
    sub: 'Enkripsi ujung-ke-ujung dan jejak audit lengkap untuk setiap transaksi pengiriman yang Anda tangani.',
  },
];
...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setError('');
    if (!email || !password) {
      setError('Silakan masukkan email dan kata sandi Anda untuk melanjutkan.');
      return;
    }
    setLoading(true);
    setTimeout(() => {
  ...
  return (
    <div className="min-h-screen flex" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="flex-1 flex flex-col justify-center bg-white px-8 py-10 sm:px-12 lg:px-16 relative overflow-hidden">
        ...
        <div className="w-full max-w-sm mx-auto relative z-10">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-between pt-1">
              <label className="flex items-center gap-2.5 cursor-pointer">
                ...
                <span className="text-sm font-medium" style={{ color: '#64748b' }}>Ingat saya</span>
              </label>
              <button
                type="button"
                onClick={() => alert('Alur riset kata sandi dimulai.')}
          ...
          <div className="flex items-center gap-4 my-7">
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#94a3b8' }}>Atau Lanjutkan Dengan</span>
            <div className="flex-1 h-px" style={{ background: '#e2e8f0' }} />
          </div>
          ...
          <button
            type="button"
            onClick={() => alert('Alur autentikasi Google dimulai.')}
      ...
      {/* ── PANEL KANAN — Visual Hero yang Dipercantik ── */}

    ...
    <div className="space-y-5 animate-fade-up">
      ...
      <div className="glass-card px-4 sm:px-5 py-4 flex flex-col gap-3">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <span className="text-xs font-bold uppercase tracking-wider" style={{ color: '#94a3b8' }}>Tingkat:</span>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <span className="text-xs font-bold" style={{ color: '#94a3b8' }}>Kategori:</span>
          {categories.map(c => (
